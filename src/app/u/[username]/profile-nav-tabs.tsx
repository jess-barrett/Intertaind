...
import { BookOpen, Film, Tv, Gamepad2, History, List, MessageSquare, Share2, User } from "lucide-react";
...
export default function ProfileNavTabs({ username }: { username: string }) {
  ...
  const tabs = [
    ...
    { href: `${base}/recommendations`, label: "Recommendations", icon: Share2, color: "text-brand" },
    { href: `${base}/lists`, label: "Lists", icon: List, color: "text-text-secondary" },
