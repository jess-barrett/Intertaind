...
export default function ShelfTabs({
  ...
  activeTab: string;
  /** Optional content rendered to the right of the tab row — used for the
      "Add [type]" shelf search button on owner views. */
  ...
  return (
    <div
      className={`mb-6 flex items-center justify-between gap-2 border-b border-surface-border pb-1 transition-opacity ${
